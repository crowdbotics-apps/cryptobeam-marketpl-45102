"""
Django settings for old_boat_45102 project.
...
ROOT_URLCONF = 'old_boat_45102.urls'
...
WSGI_APPLICATION = 'old_boat_45102.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "old_boat_45102 API",
    "DESCRIPTION": "API documentation for old_boat_45102 App",
    "VERSION": "v1",
}
